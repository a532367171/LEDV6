...
{
	internal class MarqueeDisplayPage53 : MarqueeDisplayPageBase
	{
		private int pennum;

		public MarqueeDisplayPage53(System.Drawing.Bitmap pLast, System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
			...
			lock (this.newBitmap)
			{
				lock (this.oldBitmap)
				{
					if (this.nowState == MarqueeDisplayState.First)
					{
						...
						while (i < this.newBitmap.Width)
						{
							graphics2.DrawLine(pen, new System.Drawing.Point(i, 0), new System.Drawing.Point(i, this.nowPosition));
							i += this.pennum;
							i += this.pennum;
						}
						for (i = this.pennum; i < this.newBitmap.Width; i += this.pennum)
						{
							graphics2.DrawLine(pen, new System.Drawing.Point(i, this.newBitmap.Height - this.nowPosition), new System.Drawing.Point(i, this.newBitmap.Height));
							i += this.pennum;
						}
