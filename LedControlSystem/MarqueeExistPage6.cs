...
{
	internal class MarqueeExistPage6 : MarqueeDisplayExitBase
	{
		public MarqueeExistPage6(System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
		...
		public override System.Drawing.Bitmap GetNext()
		{
			if (this.nowState == MarqueeDisplayState.First)
			{
				...
				graphics.DrawImage(this.newBitmap, new System.Drawing.Rectangle(0, this.newBitmap.Height - this.nowPosition, this.newBitmap.Width, this.nowPosition), new System.Drawing.Rectangle(0, 0, this.newBitmap.Width, this.nowPosition), System.Drawing.GraphicsUnit.Pixel);
