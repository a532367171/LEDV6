...
{
	internal class MarqueeExistPage21 : MarqueeDisplayExitBase
	{
		private System.Drawing.Point[] pointLeft;

		public MarqueeExistPage21(System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
		...
		private void GetLeft(int pLength)
		{
			if (pLength <= this.newBitmap.Height)
			{
				...
				this.pointLeft[1] = new System.Drawing.Point(0, pLength);
