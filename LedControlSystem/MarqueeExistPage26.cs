...
{
	internal class MarqueeExistPage26 : MarqueeDisplayExitBase
	{
		private System.Drawing.Point[] pointLeft;

		public MarqueeExistPage26(System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
		...
		private void GetLeft(int pLength)
		{
			...
			this.pointLeft[3] = new System.Drawing.Point(this.newBitmap.Width - num, y);
		}
