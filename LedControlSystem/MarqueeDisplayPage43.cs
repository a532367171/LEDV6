...
{
	internal class MarqueeDisplayPage43 : MarqueeDisplayPageBase
	{
		private System.Drawing.Point[] pointLeft;

		public MarqueeDisplayPage43(System.Drawing.Bitmap pLast, System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
		...
		private void GetLeft(int pLength)
		{
			if (pLength <= this.newBitmap.Width)
			{
				...
				this.pointLeft[0] = new System.Drawing.Point(0, this.newBitmap.Height);
