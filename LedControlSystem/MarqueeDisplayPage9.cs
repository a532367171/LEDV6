...
{
	internal class MarqueeDisplayPage9 : MarqueeDisplayPageBase
	{
		private int pennum;

		public MarqueeDisplayPage9(System.Drawing.Bitmap pLast, System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
			...
			lock (this.newBitmap)
			{
				lock (this.oldBitmap)
				{
					if (this.nowState == MarqueeDisplayState.First)
					{
						...
						graphics.DrawImage(this.newBitmap, new System.Drawing.Rectangle((this.newBitmap.Width - this.nowPosition) / 2, 0, this.nowPosition, this.newBitmap.Height), new System.Drawing.Rectangle((this.newBitmap.Width - this.nowPosition) / 2, 0, this.nowPosition, this.newBitmap.Height), System.Drawing.GraphicsUnit.Pixel);
						graphics.Dispose();
