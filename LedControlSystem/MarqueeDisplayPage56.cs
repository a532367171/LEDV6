...
{
	internal class MarqueeDisplayPage56 : MarqueeDisplayPageBase
	{
		private int pennum;
		...
		public MarqueeDisplayPage56(System.Drawing.Bitmap pLast, System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
			...
			lock (this.newBitmap)
			{
				lock (this.oldBitmap)
				{
					if (this.nowState == MarqueeDisplayState.First)
					{
								...
								while (i < width)
								{
									...
									for (int j = 0; j < 8; j++)
									{
										try
										{
											...
											{
												graphics.DrawLine(pen, new System.Drawing.Point(i + this.nowy, this.nowx - 8), new System.Drawing.Point(i + this.nowy, 0));
												break;
											}
										}
										catch
						...
						if (this.nowx > 0)
						{
							graphics.DrawImage(this.newBitmap, new System.Drawing.Rectangle(0, this.nowx, this.newBitmap.Width, this.newBitmap.Height - this.nowx), new System.Drawing.Rectangle(0, this.nowx, this.newBitmap.Width, this.newBitmap.Height - this.nowx), System.Drawing.GraphicsUnit.Pixel);
						}
