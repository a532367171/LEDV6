...
{
	internal class MarqueeDisplayPage36 : MarqueeDisplayPageBase
	{
		private System.Drawing.Point[] pointLeft;

		public MarqueeDisplayPage36(System.Drawing.Bitmap pLast, System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
		...
		private void GetLeft(int pLength)
		{
			...
			this.pointLeft[0] = new System.Drawing.Point(this.newBitmap.Width - num, this.newBitmap.Height - num2);
			this.pointLeft[1] = new System.Drawing.Point(this.newBitmap.Width - num, this.newBitmap.Height);
			this.pointLeft[2] = new System.Drawing.Point(this.newBitmap.Width, this.newBitmap.Height);
			this.pointLeft[3] = new System.Drawing.Point(this.newBitmap.Width, this.newBitmap.Height - num2);
		}
