...
{
	internal class MarqueeDisplayPage1 : MarqueeDisplayPageBase
	{
		public MarqueeDisplayPage1(System.Drawing.Bitmap pLast, System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
			...
			lock (this.newBitmap)
			{
				lock (this.oldBitmap)
				{
					if (this.nowState == MarqueeDisplayState.First)
					{
						...
						int arg_4D_0 = (this.newBitmap.Width - this.nowPosition) / 2;
