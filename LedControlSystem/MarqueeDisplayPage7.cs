...
{
	internal class MarqueeDisplayPage7 : MarqueeDisplayPageBase
	{
		private int pennum;

		public MarqueeDisplayPage7(System.Drawing.Bitmap pLast, System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
			...
			lock (this.newBitmap)
			{
				lock (this.oldBitmap)
				{
					if (this.nowState == MarqueeDisplayState.First)
					{
						...
						graphics.DrawImage(this.newBitmap, new System.Drawing.Rectangle(this.newBitmap.Width - this.nowPosition, 0, this.nowPosition, this.newBitmap.Height), new System.Drawing.Rectangle(this.newBitmap.Width - this.nowPosition, 0, this.nowPosition, this.newBitmap.Height), System.Drawing.GraphicsUnit.Pixel);
