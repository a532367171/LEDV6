...
{
	internal class MarqueeExistPage27 : MarqueeDisplayExitBase
	{
		private System.Drawing.Point[] pointLeft;

		public MarqueeExistPage27(System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
		...
		private void GetLeft(int pLength)
		{
			...
			this.pointLeft[1] = new System.Drawing.Point(x, this.newBitmap.Height - num);
