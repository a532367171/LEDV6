...
{
	internal class MarqueeExistPage35 : MarqueeDisplayExitBase
	{
		private System.Drawing.Point[] pointLeft;

		public MarqueeExistPage35(System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
		...
		private void GetLeft(int pLength)
		{
			if (pLength <= this.newBitmap.Width)
			{
				...
				this.pointLeft[1] = new System.Drawing.Point(pLength, 0);
			...
			this.pointLeft[2] = new System.Drawing.Point(this.newBitmap.Width, pLength - this.newBitmap.Width);
