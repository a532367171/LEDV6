...
{
	internal class MarqueeDisplayPage32 : MarqueeDisplayPageBase
	{
		private System.Drawing.Point[] pointLeft;

		public MarqueeDisplayPage32(System.Drawing.Bitmap pLast, System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
			...
			this.newBitmap = pNew;
			this.nowPositionF = (float)(this.newBitmap.Width + this.newBitmap.Height);
