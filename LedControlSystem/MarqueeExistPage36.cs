...
{
	internal class MarqueeExistPage36 : MarqueeDisplayExitBase
	{
		private System.Drawing.Point[] pointLeft;

		public MarqueeExistPage36(System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
		...
		private void GetLeft(int pLength)
		{
			if (pLength <= this.newBitmap.Width)
			{
				...
				this.pointLeft[1] = new System.Drawing.Point(this.newBitmap.Width - pLength, 0);
			...
			this.pointLeft[2] = new System.Drawing.Point(0, pLength - this.newBitmap.Width);
