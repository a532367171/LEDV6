...
{
	internal class MarqueeExistPage16 : MarqueeDisplayExitBase
	{
		private int pennum;

		public MarqueeExistPage16(System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
		...
		public override System.Drawing.Bitmap GetNext()
		{
			if (this.nowState == MarqueeDisplayState.First)
			{
				...
				for (int i = 0; i < this.newBitmap.Width; i += 8)
				{
					graphics.DrawLine(pen, new System.Drawing.Point(i + this.nowPosition, 0), new System.Drawing.Point(i + this.nowPosition, this.newBitmap.Height));
				}
				graphics.Dispose();
