...
{
	internal class MarqueeDisplayPage46 : MarqueeDisplayPageBase
	{
		private System.Drawing.Point[] pointLeft;

		private System.Drawing.Point[] pointRight;

		public MarqueeDisplayPage46(System.Drawing.Bitmap pLast, System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
		...
		private void GetLeft(int pLength)
		{
			if (pLength > this.newBitmap.Width)
			{
				...
				this.pointLeft[0] = new System.Drawing.Point(this.newBitmap.Width, this.newBitmap.Height / 2);
				this.pointLeft[1] = new System.Drawing.Point(this.newBitmap.Width, 0);
				this.pointLeft[2] = new System.Drawing.Point(0, 0);
				this.pointLeft[3] = new System.Drawing.Point(0, pLength - this.newBitmap.Width);
				this.pointRight = new System.Drawing.Point[4];
				this.pointRight[0] = new System.Drawing.Point(this.newBitmap.Width, this.newBitmap.Height / 2);
				this.pointRight[1] = new System.Drawing.Point(this.newBitmap.Width, this.newBitmap.Height);
				this.pointRight[2] = new System.Drawing.Point(0, this.newBitmap.Height);
				this.pointRight[3] = new System.Drawing.Point(0, this.newBitmap.Height - (pLength - this.newBitmap.Width));
				return;
			}
			...
			this.pointRight[0] = new System.Drawing.Point(this.newBitmap.Width, this.newBitmap.Height / 2);
			this.pointRight[1] = new System.Drawing.Point(this.newBitmap.Width, this.newBitmap.Height);
			this.pointRight[2] = new System.Drawing.Point(this.newBitmap.Width - pLength, this.newBitmap.Height);
		}
