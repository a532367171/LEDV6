...
{
	internal class MarqueeExistPage37 : MarqueeDisplayExitBase
	{
		private System.Drawing.Point[] pointLeft;

		public MarqueeExistPage37(System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
		...
		{
			if (pLength <= this.newBitmap.Height / 2)
			{
				this.pointLeft = new System.Drawing.Point[3];
				this.pointLeft[0] = new System.Drawing.Point(0, this.newBitmap.Height / 2);
				this.pointLeft[1] = new System.Drawing.Point(this.newBitmap.Width, this.newBitmap.Height / 2 - pLength);
				this.pointLeft[2] = new System.Drawing.Point(this.newBitmap.Width, this.newBitmap.Height / 2 + pLength);
				return;
			}
			this.pointLeft = new System.Drawing.Point[5];
			this.pointLeft[0] = new System.Drawing.Point(0, this.newBitmap.Height / 2);
			this.pointLeft[1] = new System.Drawing.Point(this.newBitmap.Width - (pLength - this.newBitmap.Height / 2), 0);
			this.pointLeft[2] = new System.Drawing.Point(this.newBitmap.Width, 0);
			this.pointLeft[3] = new System.Drawing.Point(this.newBitmap.Width, this.newBitmap.Height);
			this.pointLeft[4] = new System.Drawing.Point(this.newBitmap.Width - (pLength - this.newBitmap.Height / 2), this.newBitmap.Height);
		}
