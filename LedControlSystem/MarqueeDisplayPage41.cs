...
{
	internal class MarqueeDisplayPage41 : MarqueeDisplayPageBase
	{
		private System.Drawing.Point[] pointLeft;

		public MarqueeDisplayPage41(System.Drawing.Bitmap pLast, System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
		...
		private void GetLeft(int pLength)
		{
			if (pLength <= this.newBitmap.Width)
			{
				...
				this.pointLeft[2] = new System.Drawing.Point(pLength, this.newBitmap.Height);
				return;
			}
			...
			this.pointLeft[3] = new System.Drawing.Point(this.newBitmap.Width, this.newBitmap.Height - (pLength - this.newBitmap.Width));
		}
