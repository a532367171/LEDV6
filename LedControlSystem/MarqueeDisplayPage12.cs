...
{
	internal class MarqueeDisplayPage12 : MarqueeDisplayPageBase
	{
		private int pennum;

		public MarqueeDisplayPage12(System.Drawing.Bitmap pLast, System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
			...
			lock (this.newBitmap)
			{
				lock (this.oldBitmap)
				{
					if (this.nowState == MarqueeDisplayState.First)
					{
						...
						graphics.DrawImage(this.newBitmap, new System.Drawing.Rectangle(0, 0, this.newBitmap.Width, this.nowPosition / 2), new System.Drawing.Rectangle(0, 0, this.newBitmap.Width, this.nowPosition / 2), System.Drawing.GraphicsUnit.Pixel);
						graphics.DrawImage(this.newBitmap, new System.Drawing.Rectangle(0, this.newBitmap.Height - this.nowPosition / 2, this.newBitmap.Width, this.nowPosition / 2), new System.Drawing.Rectangle(0, this.newBitmap.Height - this.nowPosition / 2, this.newBitmap.Width, this.nowPosition / 2), System.Drawing.GraphicsUnit.Pixel);
						graphics.Dispose();
