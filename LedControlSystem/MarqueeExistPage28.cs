...
{
	internal class MarqueeExistPage28 : MarqueeDisplayExitBase
	{
		private System.Drawing.Point[] pointLeft;

		public MarqueeExistPage28(System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
		...
		private void GetLeft(int pLength)
		{
			...
			this.pointLeft[1] = new System.Drawing.Point(this.newBitmap.Width, this.newBitmap.Height - num2);
			this.pointLeft[2] = new System.Drawing.Point(this.newBitmap.Width, this.newBitmap.Height);
			this.pointLeft[3] = new System.Drawing.Point(this.newBitmap.Width - num, this.newBitmap.Height);
		}
