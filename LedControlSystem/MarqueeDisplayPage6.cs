...
{
	internal class MarqueeDisplayPage6 : MarqueeDisplayPageBase
	{
		private int pennum;

		public MarqueeDisplayPage6(System.Drawing.Bitmap pLast, System.Drawing.Bitmap pNew, LedEffectsSetting pSetting)
		{
			...
			lock (this.newBitmap)
			{
				lock (this.oldBitmap)
				{
					if (this.nowState == MarqueeDisplayState.First)
					{
						...
						graphics.DrawImage(this.newBitmap, new System.Drawing.Rectangle(0, 0, this.nowPosition, this.newBitmap.Height), new System.Drawing.Rectangle(0, 0, this.nowPosition, this.newBitmap.Height), System.Drawing.GraphicsUnit.Pixel);
